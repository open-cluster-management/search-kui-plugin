      ...
      switch (cell.info['header']) {
        ...
        default:
          ...
          if (this.props.kind === 'savedSearches' && cell.info['header'] === 'name') {
            ...
            return pexecInCurrentTab(
              `split --ifnot is-split --cmdline "search ${row[2].value}"`,
              undefined,
              false,
              true
            )
            ...
            return pexecInCurrentTab(
              `split --ifnot is-split --cmdline "search summary kind:${this.props.kind} ${filters}"`,
              undefined,
              false,
              true
            )
                            ...
                            {header.key !== 'action' ? (
                              <div
                                ...
                                className={`bx--table-sort-v2${
                                  sortDirection === 'asc' ? ' bx--table-sort-v2--ascending' : ''
